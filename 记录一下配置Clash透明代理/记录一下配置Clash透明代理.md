...
![Linux 透明代理在红队渗透中的应用 | 倾旋的博客](assets/1698904435-9d422b5559b8fe528996a4caff3b18f3.png)
...
师傅，我目前也是 Archlinux 作为主系统在使用，看您使用了 Clash 作为代理软件，但是对于日常的访问 google 等需求，纯 Clash 比较难用，使用 clash-for-windows 可以吗
