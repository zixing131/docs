...
在`SEH_Record[1]`处，保存着指向`SEH_Record[2]`的指针，为`0x19FFCC`，对照前面的 SEH 链，发现正好对应上，然后我们再顺着看看`SEH_Record[2]`：
...
可以看到我们的`SEH_Record[0]`地址为`0x19FE84`，我们知道了我们的 Payload 所需的大小，我们就来布置 Payload。  
这里给出我的 Payload：
