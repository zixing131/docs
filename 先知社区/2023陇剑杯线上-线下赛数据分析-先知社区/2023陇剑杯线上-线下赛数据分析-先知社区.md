...
那么答案就显而易见的在 github 仓库里有介绍，那么答案就是：**CVE-2022-22965**
...
我们使用`file`命令看看是什么东西，看到是一个 elf 文件。  
...
典型的一句话木马，将其写入至 1.php 和 info1.php。但是这个写的有点问题，难怪后面的对于 info1.php 请求会返回 404，存在这两点问题
...
反编译发现是冰蝎马。那么把最后一条 POST 上去的数据解密看看。  
