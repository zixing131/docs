...
感觉跟 MindMac 的内容有点不太一样，难道是因为版本的问题，加载 AndroidManifest.bt Template
...
手动修改在 010Editor 里面修改 AndroidManifest，例如这里修改为 00
...
遇到解析不了的 APK 的时候就会返回 True，正常解析的就会返回 False  
