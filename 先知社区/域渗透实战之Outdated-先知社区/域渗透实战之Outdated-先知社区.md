...
打开这个 pdf，经过翻译之后，发现里面一堆 cve 漏洞。估计是提示吧。
...
注册表项 HKLM:\\software\\policies\\microsoft\\windows\\WindowsUpdate 将显示正在使用的 WSUS 服务器。
