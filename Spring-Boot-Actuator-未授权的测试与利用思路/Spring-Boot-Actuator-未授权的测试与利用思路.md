...
当然也支持对端点改名，但是这种情况比较少见，当做了解下，有时候走投无路的时候，去对着文档 fuzz 一次，也许也会有收获。
...
关于这个危害我还想说明一下，因为这个只是显示最近的 100 条数据，但是我们可以写脚本来持续监控。
...
查看下 pom.xml 的 mysql-connector-java 的依赖为 8.0.12,cc 依赖为 3.2.1:
